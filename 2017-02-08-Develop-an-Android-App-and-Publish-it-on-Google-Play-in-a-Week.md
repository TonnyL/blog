...
1. 上传应用
	...
	+ 3.1.4 选择上传 APK。
		...
		![](https://ww4.sinaimg.cn/large/006tKfTcgy1fcj1k3x3yuj31kw10648b.jpg)
		
	3.2. 设置商品详情
		
	![](https://ww3.sinaimg.cn/large/006tKfTcgy1fcj1h9a33lj31kw106k1i.jpg)
...
1. 注册GitHub
	...
	[GitHub](https://github.com)是一个 <del>同性交友社区</del> 面向开源及私有软件项目的托管平台，作为开源代码库以及版本控制系统，Github拥有超过900万开发者用户。随着越来越多的应用程序转移到了云上，Github已经成为了管理软件开发以及发现已有代码的首选方法。
...
1. 安装Git
	...
	+ 在Windows上，在 Windows 上安装 Git 也有几种安装方法。
		- 官方版本可以在 Git 官方网站下载。 打开 http://git-scm.com/download/win，下载会自动开始。 要注意这是一个名为 Git for Windows的项目（也叫做 msysGit），和 Git 是分别独立的项目；更多信息请访问 http://msysgit.github.io/。
	...
	更多信息，请点击[这里](https://git-scm.com/book/zh/v2/%E8%B5%B7%E6%AD%A5-%E5%AE%89%E8%A3%85-Git)。
	
	OK，我们可以测试一下Git是否安装成功。在命令行中输入命令`git --version`查看git 的版本信息：
	
	![Git Version](https://ww4.sinaimg.cn/large/006y8lVagy1fcj3gn7ux4j312q0qk77y.jpg)
...
1. 在Android Studio中配置Git和GitHub
	...
	1. 然后在左侧设置项中选择GitHub，然后输入你刚刚注册好的GitHub账号信息，点击test，如果成功你将会看到下面的提示信息。
...
- A: 
	...
	+ 我的个人博客地址:https://TonnyL.github.io/
